...
type ImportFileConfirmSheetProps = {
  visible: boolean;
  defaultTitle: string;
  durationMs: number;
...
export function ImportFileConfirmSheet({
  visible,
  defaultTitle,
  durationMs,
  sheetTitleKey,
    ...
    >
      ...
      >
        ...
        <Text className="-mt-1 text-[13px]" style={{ color: c.text.secondary }}>
          {t('importAudio.importDuration', { time: formatTime(durationSec) })}
        </Text>
        ...
        <SheetFooterButtons
          ...
          color={c}
          primaryLabel={t(confirmLabelKey)}
