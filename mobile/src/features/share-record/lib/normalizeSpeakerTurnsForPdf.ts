...
} from './sharePdfMarkdownTables';
import { SHARE_SPEAKER_TURNS_SECTION_MARKER_RE } from './shareSectionMarkers';
...
export function normalizeSpeakerTurnsForPdf(markdown: string): string {
