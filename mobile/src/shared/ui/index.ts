...
export {
  ASK_AI_COMPOSER_TEXT_ROW_EXTRA,
  estimateAskAiComposerBottomClearance,
  estimateFloatingAudioPlayerBottomClearance,
  estimateFloatingAudioPlayerHeight,
  estimateFloatingAudioPlayerSectionHeight,
  estimateFloatingDetailDockBottomClearance,
  estimateFloatingDetailDockHeight,
  estimateFloatingDetailDockPlayerSectionHeight,
  ...
  FLOATING_AUDIO_PLAYER_CONTROLS_ROW_HEIGHT,
  FLOATING_AUDIO_PLAYER_INNER_VERTICAL_PAD,
  FLOATING_AUDIO_PLAYER_PROGRESS_BLOCK_HEIGHT,
  ...
  FLOATING_DETAIL_DOCK_INNER_VERTICAL_PAD,
  FLOATING_DETAIL_DOCK_PLAYER_BOTTOM_PAD,
  FLOATING_DETAIL_DOCK_PLAYER_CHROME_HEIGHT,
  FLOATING_DETAIL_TAB_BAR_HEIGHT,
