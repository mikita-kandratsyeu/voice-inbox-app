  ...
  const markdownStyles = useMemo(
    () => ({
      ...
      paragraph: {
        ...
        lineHeight,
        marginTop: 0,
        marginBottom: isReasoning ? 6 : isDocument ? 10 : 8,
      },
      heading1: {
        color: textColor,
        fontSize: isDocument ? 28 : isReasoning ? 15 : 18,
        lineHeight: isDocument ? 34 : isReasoning ? 22 : 26,
        fontWeight: '600' as const,
        marginTop: isDocument ? 0 : isReasoning ? 2 : 4,
        marginBottom: isDocument ? 12 : isReasoning ? 6 : 8,
      },
      heading2: {
        color: textColor,
        fontSize: isDocument ? 22 : isReasoning ? 14 : 17,
        lineHeight: isDocument ? 30 : isReasoning ? 20 : 24,
        fontWeight: '600' as const,
        marginTop: isDocument ? 16 : isReasoning ? 4 : 8,
        marginBottom: isDocument ? 8 : isReasoning ? 4 : 6,
      },
      heading3: {
        color: textColor,
        fontSize: isDocument ? 18 : isReasoning ? 13 : 16,
        lineHeight: isDocument ? 26 : isReasoning ? 20 : 24,
        fontWeight: '600' as const,
        marginTop: isDocument ? 12 : isReasoning ? 4 : 6,
        marginBottom: isDocument ? 6 : isReasoning ? 2 : 4,
      },
      strong: {
