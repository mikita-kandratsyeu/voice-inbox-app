...
**Сайт — cookies и аналитика:** когда вы просматриваете наш публичный сайт (например, лендинг, блог, страницу поддержки или просмотр резервной копии), мы используем следующие технологии:

- **Vercel Web Analytics** — помогает измерять агрегированные просмотры страниц и показатели Web Vitals. Сервис рассчитан на работу без сторонних рекламных cookies.
- **Google Analytics** (если включён на сайте) — загружается только после нажатия **«Принять»** в уведомлении о cookies. Google может устанавливать cookies и обрабатывать данные об использовании согласно [политике конфиденциальности Google](https://policies.google.com/privacy).
- **Яндекс.Метрика** (если включена на сайте) — загружается только после согласия в уведомлении о cookies. Яндекс может устанавливать cookies и использовать вебвизор, карту кликов и отслеживание ссылок согласно [политике конфиденциальности Яндекса](https://yandex.ru/legal/confidential/).

**Строго необходимые cookies:** администраторы, входящие во внутреннюю панель, получают HTTP-only cookie сессии, необходимую для безопасной авторизации. Обычные посетители эту cookie не получают.

**Хранилище браузера:** мы сохраняем ваш выбор по cookies и опциональную тему оформления (светлая/тёмная) в локальном хранилище браузера, чтобы сайт запоминал настройки.

**Ваш выбор:** необязательные скрипты аналитики (Google Analytics и Яндекс.Метрика) загружаются только после согласия через баннер cookies. Вы можете снова открыть уведомление в подвале сайта (**«Настройки cookies»**) или очистить данные сайта в браузере, чтобы сбросить выбор.
...
- **Настройки cookies** — вы можете отказаться от необязательных cookies аналитики на сайте через баннер cookies; снова откройте **«Настройки cookies»** в подвале сайта или очистите данные сайта в браузере.
