...
**На устройстве:** записи, транскрипты и контент, созданный ИИ, хранятся до тех пор, пока вы их не удалите или не удалите приложение. Если вы подключили GitHub, OAuth-токен и настройки синхронизации хранятся в системном Keychain, пока вы не отключите GitHub в настройках или не удалите приложение.
...
- **Экспортировать** — данные можно экспортировать из приложения в любой момент (в том числе ZIP-резервная копия и, при наличии права и вашем выборе, опциональная синхронизация в ваш репозиторий).
