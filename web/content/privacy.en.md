...
**Advertising (Yandex Mobile Ads):** *As of the “Last updated” date above*, unless you have an active subscription or purchase that removes advertising, the app may use **Yandex Mobile Ads** — a banner on the note detail screen and an optional rewarded ad that can grant bonus AI quota. Where required by law, we will provide consent or controls as applicable. The ad SDK operates under Yandex’s policies; we use it only to serve ads, not for cross-app tracking or analytics on our behalf.
