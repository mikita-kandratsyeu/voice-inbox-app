...
**Public note links (optional in Pro):** If you choose **Publish note** in the app share sheet, the selected note snapshot (title + chosen markdown format) is uploaded to our servers to create a public link. The link is accessible to anyone who has it. You can set an expiry period or unpublish it at any time from the app.
