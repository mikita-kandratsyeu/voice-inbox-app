      ...
      <div className="mx-auto max-w-6xl">
        <AnimateOnScroll>
          <div className="mb-8 text-center sm:mb-10">
            ...
            <p className="mx-auto max-w-2xl text-base text-black/62 dark:text-white/62">{t('subtitle')}</p>
          </div>
        </AnimateOnScroll>
        ...
        <div className="grid gap-4 md:grid-cols-3 md:gap-5">
          {USE_CASES.map(({ id, icon: Icon }, index) => (
            <AnimateOnScroll key={id} delay={index * 80}>
              <article className="h-full rounded-3xl border border-black/10 bg-white/82 p-6 shadow-[0_10px_28px_rgba(15,23,42,0.06)] dark:border-white/12 dark:bg-white/5 dark:shadow-[0_14px_40px_rgba(0,0,0,0.32)]">
