          ...
          <div className="mx-auto max-w-3xl">
            <div className={articleShellClass}>
              <div className="mb-6 flex flex-wrap items-center gap-3">
                {post.version && (
                  <span className="rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-medium text-blue-700 dark:border-blue-400/25 dark:bg-blue-500/14 dark:text-blue-300">
              ...
              <h1 className="mb-8 text-3xl font-semibold tracking-tight text-black sm:text-4xl dark:text-white">
                {post.title}
              </h1>
              <MarkdownContent content={post.body} variant="blog" />
